...
bool Game_main(volatile uint32_t* in_data, volatile uint32_t* out_data, int w, int h, int parameter_1, pixel_type card_presets[156]);


int main() {


	cv::Mat src_hls = cv::imread("/home/zx516/FirstYearProject/Pictures/bluetwo.jpg", CV_LOAD_IMAGE_UNCHANGED);
	...
	Game_main((volatile uint32_t *)image, (volatile uint32_t *)image, w, h, parameter_1, card_presets);
	...
	cv::imwrite("/home/zx516/FirstYearProject/SnapGame2/output.jpg",src_hls);
